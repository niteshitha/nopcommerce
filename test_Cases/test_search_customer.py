...
class Test_04_Search_Customer:
    ...
    def test_search_customer_by_email(self,setup):
        ...
        self.driver = setup   #This will create our initialization of ur browsers(Its a fixture)
    ...
    def test_search_customer_by_name(self,setup):
        self.logger.info("************* Test_04_002_Search_customer by name started ***********")
        self.driver = setup
        self.driver.implicitly_wait(20)
        self.driver.get(self.admin_page_url)
        self.admin_lp = Login_Admin_Page(self.driver)
    ...
    def test_search_customer_by_companyname(self,setup):
        ...
        if is_cmpname_present == True:
            ...
            self.logger.info("********* Test_04_002_Search_customer by name test failed ***********")
            self.driver.save_screenshot(".\\ScreenShots\\test_search_customer_by_company_name.png")
            self.driver.close()
            assert False
