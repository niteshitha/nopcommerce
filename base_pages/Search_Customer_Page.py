...
class Search_Customer_Page:
    ...
    #Number of results present in the search results table
    ...
    def enter_customer_companyname(self,comp_name):
        self.driver.find_element(By.ID,self.text_lastname_id).clear()
        self.driver.find_element(By.ID,self.text_lastname_id).send_keys(comp_name)

    def click_search_button(self):
        self.driver.find_element(By.ID,self.btn_search_id).click()

    def get_results_table_rows(self):    #This will give length of number of rows in the results table
        return len(self.driver.find_elements(By.XPATH,self.rows_table_xpath))

    def get_results_table_cols(self):     #This will give length of number of columns in the results table
        return len(self.driver.find_elements(By.XPATH,self.columns_table_xpath))

    def search_customer_by_email(self,email):  #This function will return either 2 boolean values either TRUE or FALSE
    ...
    def search_customer_by_company(self,company_name):
        ...
        for r in range(1,self.get_results_table_rows()+1):
            cus_company_name = self.driver.find_element(By.XPATH,
