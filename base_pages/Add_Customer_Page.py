...
#### Adding new customer through Customers option in web app #############
class Add_Customer_Page:
    ...
    link_addnew_xpath = "//a[@class='btn btn-primary']"  # Its "AddNew" button
    text_email_id = "Email"
    ...
    btn_save_xpath = "//button[@name='save']"
     ...
     #Created one constructor
    def __init__(self,driver):
        self.driver = driver   # By this we are accessing all the locators in the methods
    ...
    def enter_email(self,email):          #From test case we will pass Email-ID
    ...
    def select_gender(self,gender):    # We will take gender value from test case
        if gender == "Male":
    ...
    def select_newsletter(self,value):
        elements = self.driver.find_elements(By.XPATH,self.newsletter_cusrole_list_xpath)   #This is a list element, which will store 2
